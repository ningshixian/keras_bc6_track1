...
def create_custom_objects():
    ...
    return {'CRF': ClassWrapper, 'loss': loss, 'loss_function': loss_function}
...
if __name__ == '__main__':
    ...
    inp2 = Input(shape=(2,))
    xx = Embedding(vocab_size, n_classes)(inp2)
    inp_aux = Input(shape=(2,))
    x_aux = Embedding(vocab_size, n_classes)(inp_aux)
    inp2_aux = Input(shape=(2,))
    xx_aux = Embedding(vocab_size, n_classes)(inp2_aux)
    ...
    model.compile(loss=[crf.sparse_loss, crf.sparse_loss], optimizer='sgd') # ok
