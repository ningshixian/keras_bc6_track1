...
def getData(trainCorpus, sen_len_list):
    ...
    for name in ['train', 'devel']:
        with open(trainCorpus + '/' + name + '.out', encoding='utf-8') as f:
            data_sen = []
            char_sen = []
            cap_sen = []
            labels_sen = []
...
if __name__ == '__main__':
    datasDic, charsDic, capDic, labelsDic = getData(corpusPath, sen_len_list)
    ...
    with open(corpusPath+'/train.pkl', "wb") as f:
        pkl.dump((datasDic['train'], labelsDic['train'], charsDic['train'], capDic['train']), f, -1)
    with open(corpusPath+'/devel.pkl', "wb") as f:
        pkl.dump((datasDic['devel'], labelsDic['devel'], charsDic['devel'], capDic['devel']), f, -1)
