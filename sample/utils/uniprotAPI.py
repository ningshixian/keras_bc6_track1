...
if __name__ == '__main__':
    ...
    Ids = get_id_from_bioservice('CHDB')   # Uniprot:P47806|NCBI gene:14632|Uniprot:P08151|NCBI gene:2735
    print(Ids)

    Ids = get_id_from_bioservice('Ptch1')  # Uniprot:P47806|NCBI gene:14632|Uniprot:P08151|NCBI gene:2735
    print(Ids)
