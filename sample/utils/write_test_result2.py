...
def writeOutputToFile(path, predLabels):
    ...
    # cnn = load_model('/home/administrator/PycharmProjects/keras_bc6_track1/sample/ned/data/weights2.02-0.28.hdf5')
    ...
    print('num_match:{}, not_find:{}'.format(num_match, not_find))  #
    print('测试集预测结果写入成功！')
